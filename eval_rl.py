...
def main():
    ...
    prev_known_cells       = 0
    prev_trk_lost          = False  # FIX: track transitions, not every step
    ...
    try:
        for step in range(1, max_steps + 1):
            ...
            # Tracking lost events — count transitions, not every step
            if trk_lost and not prev_trk_lost:
                total_tracking_lost += 1
            prev_trk_lost = trk_lost
